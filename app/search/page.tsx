            ...
            <Popover>
                <PopoverTrigger asChild>
                    <div className="space-y-2 cursor-pointer hover:opacity-75 drop-shadow-md">
                        <div className="bg-slate-500/50 p-1 rounded-xl text-white text-sm text-center">$300</div>
...
const SearchPage = () => {
    return (
        <div className="h-[calc(90%-64px)] grid grid-cols-5 p-6  max-w-screen-xl mx-auto gap-4">
